...
export const SECTIONS: MapSection[] = [
  ...
  /* ------------------------------------------------------------ agency */
  {
    ...
    name: "Week",
    href: "/week",
    blurb: "The funnel: bids out, chats opened, contracts won, per account.",
    access: "everyone",
    inNav: true,
    group: "agency",
    does: [
      "Type Monday's bid count for each of the four accounts — the one number Upwork will not give us",
